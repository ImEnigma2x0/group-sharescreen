...
export const metadata: Metadata = {
  title: "Relatório do anúncio",
  description: "Estatísticas em tempo real de um anúncio no GoLive.",
  robots: { index: false, follow: false, nocache: true, noarchive: true },
};

export default async function PartnerReportPage(props: PageProps<"/anuncio/[token]">) {
